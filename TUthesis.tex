...
\lstset{numbers=left, stepnumber=2, frame=lines, tabsize=2, language=Python, basicstyle=\footnotesize, showstringspaces=false,captionpos=b, numberstyle=\tiny,}
%
...
%\includeonly{Chapter1,Chapter2,Chapter3,Chapter4,Chapter5,Conclusion,Appendices}
...
%
\titleoneline{Modeling Cyber-Physical Attacks With Hybrid Attack Graphs}
\title{Modeling Cyber-Physical Attacks With Hybrid Attack Graphs}
...
\numofchapters=\ref{conclusion}                   % number of chapters in the document
\numofabstractwords{106}            % number of words in the abstract

...
\usepackage{listings} \lstset{basicstyle=\small}
\usepackage{lastpage}
\usepackage{url}
...
%
\titleoneline{Hybrid Attack Graphs For Modeling Cyber-Physical Systems}
...
role of Aleks Kissinger in the whiteboard conversation that resulted in the 
...
I would also like to thank my advisor, Dr. John Hale, for his patience and
guidance, as well as my other committee members..
% Leech?

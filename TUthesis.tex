...
%
\titleoneline{Hybrid Attack Graphs: A Tool For Modeling Cyber Physical Systems Security}
% The title with line breaks for the front pages:
\title{Hybrid Attack Graphs: A Tool For Modeling Cyber Physical Systems Security}

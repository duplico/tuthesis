...
attack space~\cite{} using preconditions and postconditions share a common
general architecture, pictured in Fig. \ref{fig:generation}. The attack graph generation

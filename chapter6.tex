...
\begin{figure}
\includegraphics[width=5in]{perf/asset_time}
\caption{Execution time vs. number of assets}
\label{fig:assetperf}
\end{figure}

\begin{figure}
\includegraphics[width=5in]{perf/asset_time_log}
\caption{Execution time vs. number of assets (log scale)}
\label{fig:assetperflog}
\end{figure}

\begin{figure}
\includegraphics[width=5in]{fullbunny_s5_d2}
...
\begin{figure}
\includegraphics[width=5in]{perf/depth_time}
\caption{Execution time vs. generation depth}
\label{fig:depthperf}
\end{figure}

\begin{figure}
\includegraphics[width=5in]{perf/depth_time_log}

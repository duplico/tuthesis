...
by the \texttt{=} symbol. The asset list is a semicolon separated list of the names of network
assets preceded by the word \texttt{assets} and a colon. Following the asset list, the initial
fact base is specified as a semicolon separated list of facts.
\begin{lstlisting}
network model = 
assets :
attacker;
...
facts :
	quality:webserver,MoinMoin,vuln_stack_overflow;
	quality:printer,access,open;
	quality:printer,ready_message,READY;
	topology:attacker,webserver,connected_web;

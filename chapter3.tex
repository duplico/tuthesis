...
Several standard or at least consistent terms are used across the NVD's
index of vulnerabilities. These terms relate to a vulnerability's access vector,
and an affected system's status and type.

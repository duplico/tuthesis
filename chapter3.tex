...
\begin{description}
    \item[Qualities] Qualities bind an asset to a property to a value; therefore their
        ...
        \end{align}
    \item[Qualities] Topologies bind an asset to another asset through a relationship; therefore their
        domain is the cartesian product of those domains:
        \begin{align}
            \mathcal{T}_n&: \mathcal{A} \times \mathcal{A} \times \mathcal{R}
        \end{align}
    \item[Qualities] A network state, then, is denoted by a collection of assets, and a fact base
